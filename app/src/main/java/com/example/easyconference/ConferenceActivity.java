...
public class ConferenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareBtn.setOnClickListener(view -> { // to share meeting id
            ...
            intent.putExtra(Intent.EXTRA_TEXT,"Join a meeting in Easy Conference \n Meeting ID : "+meetingID); // the text to share
    ...
    public void addFragment() {
        ...
        config.turnOnCameraWhenJoining = false; //when joining camera will be off
        config.turnOnMicrophoneWhenJoining = false; ////when joining microphone will be off
